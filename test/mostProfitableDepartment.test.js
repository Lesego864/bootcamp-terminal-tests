...
describe('The mostProfitableDepartment function', function () {
    ...
    it('should return the most profitable department in dataset 1.', function () {
        assert.equal('outdoor', mostProfitableDepartment([
            ...
            { department: 'carpentry', sales: 16109, day: 'Friday' },]), "Most profitable department is 'outdoor' for dataset 1");
    });
it('should return the most profitable department in dataset 2.', function () {
    var salesData2 =
        assert.equal('electronics', mostProfitableDepartment([
            ...
            { department: 'carpentry', sales: 8009, day: 'Wednesday' },]), "Most profitable department is 'electronics' for dataset 2");
});
